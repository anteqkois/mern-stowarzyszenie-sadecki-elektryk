...
import TestListOfNumber from './TestListOfNumber';
...
const InstructionHowToAid = ({ activeStep, stepToShow, handleNextStep }) => {
  return (
    <StyledInstructionHowToAid>
      {/* ListOfNumber to komponent odpowiedzialny za numet do zmiany  */}
      <TestListOfNumber activeStep={activeStep} handleNextStep={handleNextStep} />
